...
<main class="full">
    ...
    <div class="store--info">
        ...
        <a class="hvr-grow" href="/en/our-collections/" title="Online Store">
            ...
            <a class="hvr-grow" href="/nos-collections/" title="Boutique en ligne">
                <?php endif; ?>
    ...
    <div class="home--services">
        ...
        <div class="col-12 col-md-6 col-lg">
            <a href="<?php echo get_site_url(); ?>/en/services-2/" title="<?php esc_html_e('Evaluation', 'bab'); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/images/collections/estimation-evaluation-accue.jpg"
                    alt="<?php esc_html_e('Evaluation', 'bab'); ?>"
                    title="<?php esc_html_e('Evalution Jewelry', 'bab'); ?>" class="img-fluid">
        ...
        <div class="col-12 col-md-4 col-lg">
            <a href="<?php echo get_site_url(); ?>/en/product-category/synthetic-stones-jewelry/"
                title="<?php esc_html_e('Synthetic Stones Jewelry', 'bab'); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/images/collections/synthetic-stones-jewelry.jpg"
                    alt="<?php esc_html_e('Synthetic Stones Jewelry', 'bab'); ?>"
                    title="<?php esc_html_e('Synthetic Stones Jewelry', 'bab'); ?>" class="img-fluid">
    ...
    <div class="home--services">
        ...
        <div class="col-12 col-md-6 col-lg">
            <a href="<?php echo get_site_url(); ?>/services/#serviceEstimation" title="Évaluation &amp; estimation">
                <img src="<?php echo get_template_directory_uri(); ?>/images/collections/estimation-evaluation-accue.jpg"
                    alt="Évaluation &amp; estimation" title="Évaluation &amp; estimation" class="img-responsive">
        ...
        <div class="col-12 col-md-4 col-lg">
            <a href="<?php echo get_site_url(); ?>/categorie-produit/bijoux-synthetiques/"
                title="Bijoux pierres synthétiques">
                <img src="<?php echo get_template_directory_uri(); ?>/images/collections/bijoux-synthetiques.jpg"
                    alt="Bijoux pierres synthétiques" title="Bijoux pierres synthétiques" class="img-responsive">
    ...
    <div class="home--expertise">
        <div class="col-12 col-lg-6">
            <img src="<?php echo get_template_directory_uri(); ?>/images/jocelyne-portrait.png" alt="Jocelyne Rouleau"
                title="Jocelyne Rouleau">
        </div>
        <div class="home--expertise__text">
            <h2>Jocelyne
                Rouleau,<br><?php esc_html_e('Diamond-Gemologist', 'bab'); ?><br><?php esc_html_e('for 25 years', 'bab'); ?>
            </h2>
            <p><?php esc_html_e('A graduate of the Gemmological Association of Great Britain and the Canadian Gemmology Association, Ms. Rouleau is also a Certified Valuation Assessor of the Canadian Jewelers Association.', 'bab'); ?>
            </p>

            <?php if (ICL_LANGUAGE_CODE == 'en') : ?>
            <button class="btn btn-secondary btn-lg"><a
                    href="<?php echo get_site_url(); ?>/en/services-2/">Services</a></button>
            <?php elseif (ICL_LANGUAGE_CODE == 'fr') : ?>
            <button class="btn btn-secondary btn-lg"><a
                    href="<?php echo get_site_url(); ?>/services/">Services</a></button>
            <?php endif; ?>
