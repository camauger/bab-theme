                    ...
                    <div class="row--flex">
                        <div class="block--half">
                            <div class="block--text">
                                ...
                                <a class="btn btn-primary" href="<?php echo get_site_url(); ?>/contact" title="Contactez-nous">Contactez-nous</a>
                            </div>
                        </div>
                        <div class="block--image">
                            <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2018/09/valeur.jpg">
                        </div>
                    </div>
...
L’achat d’un bijou d’occasion, contrairement à un bijou neuf, est empreint d’histoire et de vécu.</p>
                    ...
                    <div class="row--flex">
                        <div class="block--half">
                            <div class="block--text">
                                ...
                                <a class="btn btn-primarye" href="<?php echo get_site_url(); ?>/demande-estimation" title="Demandez-nous une estimation">Demandez-nous une estimation</a>
                    ...
                    <div class="row--flex">
                        <div class="block--half">
                            <div class="block--text">
                                ...
                                <a class="btn btn-primary" href="<?php echo get_site_url(); ?>/demande-estimation" title="Demandez-nous une estimation">Demandez-nous une estimation</a>
                    ...
                    <aside class="block--expertise">
                        ...
                        <nav class="col-12 col-md-8">
                            <a title="Qu’est-ce qui motive la vente d’un bijou?" href="<?php echo get_site_url(); ?>/questions-reponses/#faq-6858">
                                <i class="fas fa-gem"></i> Qu’est-ce qui motive la vente d’un bijou?
                            </a>
                            <a title="Devriez-vous faire fondre vos bijoux ?" href="<?php echo get_site_url(); ?>/questions-reponses/#faq-6856">
